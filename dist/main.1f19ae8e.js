...
var CONTRACT_NAME = undefined || 'helloworld.gameofstake.testnet';
  ...
  switch (env) {
    ...
    case 'local':
      return {
        ...
        keyPath: "".concat("/home/t", "/.near/validator_key.json"),
...
function updateUI() {
  if (!window.walletConnection.getAccountId()) {
    ...
    contract.get_helloworld({
      "message": window.accountId
